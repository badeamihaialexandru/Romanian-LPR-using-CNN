...
# convertesc etichetele din numarul x in 1 pe coloana x
...
def optimize(num_iterations):
    ...
    for i in range(total_iterations,
        ...
        x_batch,y_true_batch=next_batch(train_batch_size,img,lbl)
...
imported_graph = tf.train.import_meta_graph('my-model.meta')
saver.restore(session, './my-model')

#**************de ce ai initializa variabilele daca le ai salvate **********************
